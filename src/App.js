...
function ChatMessage(props) {
  ...
  return (
    <div className={`message ${messageClass}`}>
      <img src={'https://static.vecteezy.com/system/resources/previews/014/194/216/non_2x/avatar-icon-human-a-person-s-badge-social-media-profile-symbol-the-symbol-of-a-person-vector.jpg'} alt="avatar" />
      <p>{text}</p>
    </div>
  );
}
